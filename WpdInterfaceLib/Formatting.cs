...
namespace WpdInterfaceLib
{
    ...
    {   // todo: clean this up, most is unused and unwanted
		...
		public Formatting Clone()
		{
            ...
            newf.CharacterStyleName = CharacterStyleName;
			return newf;
		}
    ...
    //            if (!string.IsNullOrEmpty(CharacterStyleName))
    //            {
    //                rPr.Add(new XElement(XName.Get("rStyle", DocX.w.NamespaceName), string.Empty, new XAttribute(XName.Get("val", DocX.w.NamespaceName), CharacterStyleName)));
    //            }
    ...
    //        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (!(other.CharacterStyleName ?? "").Equals(CharacterStyleName))
                return -1;

            return 0;
        }

        public string CharacterStyleName { get; set; }
    }
}
